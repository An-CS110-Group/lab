...
.LFB505:
	...
	movaps	%xmm0, -352(%rbp)
	leaq	-48(%rbp), %rax
	addq	$16, %rax                       # Calculate (C+2) in bits
	movq	%rax, -424(%rbp)
	movq	-424(%rbp), %rax
	...
	jmp	.L4                                 # Go to loop
.L14:
	movl	-428(%rbp), %eax                # Main body of loop
	addl	%eax, %eax
	cltq
	leaq	0(,%rax,8), %rdx
	leaq	-112(%rbp), %rax
	...
	movsd	(%rax), %xmm0
	movsd	%xmm0, -384(%rbp)
	movsd	-384(%rbp), %xmm0               # Unpack and Interleave Low Packed Double-Precision Floating-Point Values
